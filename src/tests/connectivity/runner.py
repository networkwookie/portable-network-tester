...
from tests.connectivity.models import TestResult, TestStatus
from tests.connectivity.link import LinkTester
from tests.connectivity.neighbor import NeighborDiscovery
from tests.connectivity.ip_services import IPServicesTester
from tests.connectivity.reachability import ReachabilityTester
...
class ConnectivityTestRunner:
    ...
    def run_all_tests(
        ...
        if results['physical_link'].status != TestStatus.PASSED:
